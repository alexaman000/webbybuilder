        ...
        <div className="flex flex-col md:flex-row justify-between items-end mb-16">
          <div className="max-w-xl">
            ...
            >
              ...
              <span className="uppercase tracking-widest text-xs font-bold text-neutral-400">Resources</span>
            </motion.div>
            <motion.h2
          ...
          <Link
            href="#"
            className="group flex items-center gap-2 font-medium text-white hover:text-neutral-300 transition-colors mt-6 md:mt-0"
          >
            Read All Articles 
            ...
            <Link key={index} href={`/blog/${article.slug}`}>
              ...
              >
                <div className="flex items-center justify-between mb-6">
                  <span className="px-3 py-1 rounded-full border border-white/10 text-white text-xs font-semibold tracking-wider uppercase bg-white/5">
                    {article.category}
                  </span>
                ...
                <h3 className="text-2xl font-bold mb-4 text-white group-hover:text-neutral-200 transition-colors">
                  {article.title}
                </h3>
